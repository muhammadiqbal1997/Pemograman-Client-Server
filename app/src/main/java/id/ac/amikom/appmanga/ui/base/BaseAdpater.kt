package id.ac.amikom.appmanga.ui.base
...
abstract class BaseAdpater<T>(@field:LayoutRes private var layoutId: Int):
        RecyclerView.Adapter<BaseAdpater<T>.ViewHolder>(), BindableAdapter<List<T>>{
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun onBind(variable: Int?, data: Any?) : ViewDataBinding? {
